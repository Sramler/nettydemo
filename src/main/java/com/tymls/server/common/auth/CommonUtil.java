package com.tymls.server.common.auth;
...
public final class CommonUtil {
  ...
  public static String parserResponse(PostMethod method) throws IOException {
    ...
    BufferedReader reader =
        new BufferedReader(new InputStreamReader(in, method.getResponseCharSet()));
   ...
   * @return
   */
  public static String buildInvokeUrlPath(
      String apiNamespace, String apiName, int apiVersion, String protocol, String appKey) {
